...
public class DsdcoDisciplinaryService {
    ...
    private final DefaultMQPushConsumer consumer = new DefaultMQPushConsumer(mqConfig.getString("consumerGroupDisciplinary1"));
    private final DefaultMQProducer producer = new DefaultMQProducer(mqConfig.getString("producerGroupDisciplinary1"));
    ...
    public void initializeConsumer() throws MQClientException {
        ...
        consumer.setInstanceName(mqConfig.getString("consumerInstanceNameDisciplinary1"));
        consumer.subscribe(mqConfig.getString("system2DisciplinaryTopic"), mqConfig.getString("tag"));
        ...
        consumer.start();
        System.out.println("Consumer of the disciplinary1 of the reducer is started");

        // initialize the producer
        producer.setNamesrvAddr(mqConfig.getString("nameServerAddress"));
        producer.setInstanceName(mqConfig.getString("producerInstanceNameDisciplinary1"));
        producer.start();
    }
