...
import reducer.handler.DisciplinaryHandler2;
...
public class DsdcoDisciplinaryService {
    ...
    private final DefaultMQPushConsumer consumer = new DefaultMQPushConsumer(mqConfig.getString("consumerGroupDisciplinary2"));
    private final DefaultMQProducer producer = new DefaultMQProducer(mqConfig.getString("producerGroupDisciplinary2"));
    ...
    public void initializeConsumer() throws MQClientException {
        ...
        consumer.setInstanceName(mqConfig.getString("consumerInstanceNameDisciplinary2"));
        ...
        producer.setInstanceName(mqConfig.getString("producerInstanceNameDisciplinary2"));
        producer.start();
    }
