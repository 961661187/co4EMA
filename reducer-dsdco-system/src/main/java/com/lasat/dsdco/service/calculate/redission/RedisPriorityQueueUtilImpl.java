...
public class RedisPriorityQueueUtilImpl<T> implements RedisPriorityQueueUtil<T>{
     ...
     */
    public RedisPriorityQueueUtilImpl(int variableCount, long taskId, Comparator<T> comparator, int flushThreshold, String host, String port, String password) {
