...
public class DsdcoDisciplinaryService {
    ...
    private final DefaultMQPushConsumer consumer = new DefaultMQPushConsumer(mqConfig.getString("consumerGroupDisciplinary1Test"));
    private final DefaultMQProducer producer = new DefaultMQProducer(mqConfig.getString("producerGroupDisciplinary1Test"));
    ...
    public void initializeConsumer() throws MQClientException {
        ...
        consumer.setInstanceName(mqConfig.getString("consumerInstanceNameDisciplinary1Test"));
        ...
        producer.setInstanceName(mqConfig.getString("producerInstanceNameDisciplinary1Test"));
        producer.start();
    }
