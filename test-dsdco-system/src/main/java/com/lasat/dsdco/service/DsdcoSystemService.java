...
public class DsdcoSystemService {
    ...
    private final int VARIABLES_COUNT = 2;
    private final int DISCIPLINARY_COUNT = 2;
    private final int maxIteratorCount = 10000;
    ...
    public void initializeConsumer() {
        ...
        consumer.setInstanceName(mqConfig.getString("consumerInstanceNameTest"));
        try {
            consumer.subscribe(mqConfig.getString("disciplinary2SystemTopicTest"), mqConfig.getString("tagTest"));
